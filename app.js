...
const I18N = {
  zh: {
    ...
    "welcome.subtitle":
      "欢迎来访我的个人站点。语言可在右上角小开关切换。进入主页后可查看简介摘要与作品大图预览；完整履历与 PDF 导出在「简历」页，每个项目可进入详情阅读全文。",
  ...
  en: {
    ...
    "welcome.subtitle":
      "Thanks for stopping by. Use the small switch in the corner for language. Then continue: a short profile and large project previews on the home page; the full resume with PDF export is on the Resume page; each project has its own detail page.",
